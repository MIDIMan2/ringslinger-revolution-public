-- Ringslinger Revolution - EHP Flash System

--- Initializes the player's EHP flash system.
...
--- Sets variables for the player's EHP flash.
---@param player player_t
---@param color integer
---@param tics tic_t
...
--- Runs the thinker for the player's EHP flash.
---@param player player_t
