-- Ringslinger Revolution - Freeslots
...
freeslot(
	...
	"sfx_railht", -- Created by orbitalviolet
	...
	"sfx_rsrpmp", -- Created by orbitalviolet
	"sfx_rsrsmp", -- Created by orbitalviolet
	"sfx_rsrpng",
	"sfx_rsrinv", -- Created by orbitalviolet, sort of
	"sfx_rsrcrk",
	"sfx_rsrast",
	"sfx_rsrkil",
	"sfx_rsrsp1",
...
freeslot(
	...
	"MT_RSR_PROJECTILE_BASIC_CHARGED",
	-- Scatter
	"SPR_RSWS",
	"SPR_RSBS",
	...
	"MT_RSR_PROJECTILE_SCATTER_FLAKCANNON",
	...
	"MT_RSR_PROJECTILE_BOUNCE_MEGABOMB",
	"MT_RSR_PROJECTILE_BOUNCE_MEGABOMB_SUBMUNITION",
	"S_RSR_PROJECTILE_BOUNCE",
	"S_RSR_PROJECTILE_BOUNCE_MEGABOMB",
	-- Grenade
	"SPR_RSWG",
	"SPR_RSBG",
	...
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMB",
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMB_ARMED",
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMB_DETONATE",
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMBGROUND",
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMBGROUND_ARMED",
	"S_RSR_PROJECTILE_GRENADE_STICKYBOMBGROUND_DETONATE",
	...
	"MT_RSR_PROJECTILE_BOMB_MISSILEFORM",
	"MT_RSR_PROJECTILE_SUPERBOMB_MISSILEFORM",
	...
	"MT_RSR_PROJECTILE_HOMING_BOMB",
	"S_RSR_PROJECTILE_HOMING",
	"S_RSR_PROJECTILE_HOMING_BOMB",
	"S_RSR_NIGHTSPARKLE_WASP",
	-- Rail
	"SPR_RSWI",
	"MT_RSR_PICKUP_RAIL",
	"S_RSR_PICKUP_RAIL",
...
--	"SPR_RSWI",
	"MT_RSR_PICKUP_BFR",
	"S_RSR_PICKUP_BFR",
	"MT_RSR_PROJECTILE_BFR",
	"S_RSR_PROJECTILE_BFR"
)

-- Strong Random Monitor
-- Adapted from CoolRS (Thanks, Sylve!)
freeslot(
	"SPR_RSMN",
	"S_RSR_STRONGBOX",
	"S_RSR_STRONGBOX_FLICKER",
	"S_RSR_STRONGBOX_POP1",
	"S_RSR_STRONGBOX_POP2",
	"S_RSR_STRONGBOX_ICON"
)

-- EFX/Misc
freeslot(
	"MT_RSR_DAMAGE_SPLATTER",
	"S_RSR_DAMAGE_SPLATTER",
	"SPR_RSTF",
	"S_RSR_TELEFOG",
	"S_RSR_TELEFOG_SOUND",
	"MT_RSR_ENEMYSPAWNER",
...
sfxinfo[sfx_rsrinv].caption = "Broke their armor!"
